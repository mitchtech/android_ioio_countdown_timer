...
public class ManageNotification {
	...
	public static void show(Context context, String scrollMessage, String statusMessage) {
		...
		if (myPrefs
				.getBoolean(context.getString(R.string.pref_show_persistent_notification), false)) {

			createNM(context);

			// Set the icon, scrolling text and timestamp
			Notification notification = new Notification(R.drawable.alarm_icon, scrollMessage,

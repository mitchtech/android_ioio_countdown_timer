...
public class TimerAlarmReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		String flashLedCol = myPrefs.getString(context.getString(R.string.pref_flashled_color),
				"yellow");
		int timeout = Integer.valueOf(myPrefs.getString(context.getString(R.string.pref_timeout),
		...
		Uri alarmSoundURI = Uri.parse(myPrefs.getString(
				context.getString(R.string.pref_alarmsound), defaultRingtone));

		// Set the icon, scrolling text and timestamp
		Notification notification = new Notification(R.drawable.alarm_icon,
				context.getText(R.string.timer_complete), System.currentTimeMillis());
		...
		TimerAlarmActivity.PinState = true;
		...
		// Set a future receiver to cancel all held locks (wakelock and keyguard
		// lock)
